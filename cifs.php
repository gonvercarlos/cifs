...
<div class="topbar">
  ...
  <div>
    <div class="search">
      <form method="get" action="<?php echo htmlspecialchars(BASE_PATH . '/cifs.php', ENT_QUOTES, 'UTF-8'); ?>">
...
?>
  <div style="margin-left:12px;">
    <form style="display:inline;" method="get" action="<?php echo htmlspecialchars(BASE_PATH . '/cifs.php', ENT_QUOTES, 'UTF-8'); ?>">
